...
export type FetchPendingPoolsQueryVariables = Exact<{ [key: string]: never }>;

export type FetchPendingPoolsQuery = {
  __typename?: 'Query';
  pools: Array<{
    __typename?: 'Pool';
    id: string;
...
export const FetchPendingPoolsDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchPendingPools(
      variables?: FetchPendingPoolsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<FetchPendingPoolsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<FetchPendingPoolsQuery>(FetchPendingPoolsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'fetchPendingPools',
