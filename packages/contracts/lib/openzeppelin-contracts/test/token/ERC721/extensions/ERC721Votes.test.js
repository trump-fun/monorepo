    ...
    describe(`vote with ${mode}`, function () {
      ...
      describe('transfers', function () {
        ...
        it('generally returns the voting balance at the appropriate checkpoint', async function () {
          ...
          await mine(2);
          const t2 = await this.votes
            .connect(this.holder)
            .transferFrom(this.holder, this.other2, tokens[0]);
          await mine(2);
          const t3 = await this.votes
            .connect(this.holder)
            .transferFrom(this.holder, this.other2, tokens[2]);
          await mine(2);
          const t4 = await this.votes
            .connect(this.other2)
            .transferFrom(this.other2, this.holder, tokens[2]);
          await mine(2);
