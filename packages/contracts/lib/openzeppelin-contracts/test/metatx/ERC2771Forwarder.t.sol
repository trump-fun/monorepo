...
contract ERC2771ForwarderTest is Test {
  ...
  function _tamperedExpectRevert(
    ...
    if (tamper == TamperType.TO) {
      ...
      (address recovered, , ) = _erc2771Forwarder
        .forwardRequestStructHash(request, nonce)
  ...
  function testExecuteAvoidsETHStuck(
  ...
  function testExecuteBatchAvoidsETHStuck(
    uint256 initialBalance,
    uint256 batchSize,
    uint256 value
  ) public {
    ...
    ERC2771Forwarder.ForwardRequestData[]
      memory requests = new ERC2771Forwarder.ForwardRequestData[](batchSize);
  ...
  function testExecuteBatchTamperedValuesZeroReceiver(uint8 _tamper) public {
    ...
    ERC2771Forwarder.ForwardRequestData[]
      memory requests = new ERC2771Forwarder.ForwardRequestData[](3);
