...
function shouldBehaveLikeMap() {
  ...
  describe('set', function () {
    it('adds a key', async function () {
      await expect(this.methods.set(this.keyA, this.valueA))
        .to.emit(this.mock, this.events.setReturn)
        .withArgs(true);
  ...
  describe('remove', function () {
    it('removes added keys', async function () {
      ...
      await expect(this.methods.remove(this.keyA))
  ...
  describe('read', function () {
    ...
    describe('tryGet', function () {
      ...
      it('missing value', async function () {
        expect(await this.methods.tryGet(this.keyB)).to.have.ordered.members([
          false,
          this.zeroValue,
        ]);
      });
