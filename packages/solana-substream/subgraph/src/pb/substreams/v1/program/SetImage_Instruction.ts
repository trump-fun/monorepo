...
export class SetImage_Instruction {
  static encode(message: SetImage_Instruction, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): SetImage_Instruction {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new SetImage_Instruction();
